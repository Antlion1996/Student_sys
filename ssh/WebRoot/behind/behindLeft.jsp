					...
					<TD vAlign=top bgColor=#799ae1>
						...
						<TABLE cellSpacing=0 cellPadding=0 width=158 align=center>
							<TBODY>
								...
								<TR>
									<c:set var="admin" value="${sessionScope.adminer}" />
									<TD class=menu_title
										onMouseOver="this.className='menu_title2';"
										onmouseout="this.className='menu_title';" height=25>
										&nbsp;管理员：${admin.name }
										...
										<DIV class=sec_menu style="WIDTH: 158px;margin-top: 5px;">
											<TABLE cellSpacing=0 cellPadding=0 width=135 align=center>
												<TBODY>
													...
													<TR>
														<TD height=20>
															<a href="<%=basePath%>studentAction!listStudent.action" target="mainFrame">学生列表</a>
														</TD>
													</TR>
													<TR>
														<TD height=20>
										...
										<DIV class=sec_menu style="WIDTH: 158px;margin-top: 5px">
											<TABLE cellSpacing=0 cellPadding=0 width=135 align=center>
												<TBODY>
													<TR>
														<TD height=20>
															<a href="<%=basePath%>teacherAction!listTeacher.action" target="mainFrame">教师列表</a>
														</TD>
													</TR>
													<TR>
														<TD height=20>
